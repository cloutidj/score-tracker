...
import { ScoringConfigManagerComponent } from '../../end-game-scoring/config-manager/scoring-config-manager.component';
import { PanelId, PanelService } from '../panel.service';
