 ...
 *
 * See docs/UI-COMPONENTS.md § Number pad for the summing (`+`/`parts`/`expression`) and
 * no-Enter (`showEnter`) design.
 */
@Component({
...
export class NumberPadComponent {
   ...
   *  key (see docs/UI-COMPONENTS.md § Number pad) for a standalone tally with nothing to commit to. */
